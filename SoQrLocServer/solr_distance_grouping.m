...
rootFolder = "./data/experimentdata/dataCollectionDistanceTest/US/100%/1/No_degree/No_distance";
...
device1_folder = './data/experimentdata/dataCollectionDistanceTest/US/100%/1/No_degree/No_distance/device1'; 
device2_folder = './data/experimentdata/dataCollectionDistanceTest/US/100%/1/No_degree/No_distance/device2'; 
device3_folder = './data/experimentdata/dataCollectionDistanceTest/US/100%/1/No_degree/No_distance/device3'; 
device4_folder = './data/experimentdata/dataCollectionDistanceTest/US/100%/1/No_degree/No_distance/device4'; 


%dataFolders = {device1_folder,device2_folder,device3_folder};
...
[idx,C,sumd] = kmeans(results_modified, numClusters,'Replicates',10);%make sure the diagonal results are the same
